...
// motor B(left  motor) connected between B01 and B02
    ...
    psiController.SetPID(30, 150, 0.6);      // KP, KI, KD  80, 500, 0.5
    psiController.SetReference(-0.02);           // Reference

    // pos Controller
    posController.SetSaturation(0.025, -0.025);  // 0.02 ~ -0.02rad
    posController.SetToleratedError(5);        // 5cm
    posController.SetPID(0.001, 0.2, 0);            // KP, KI, KD
